...
class C3D(nn.Module):
    ...
    def __init__(self, num_classes, pretrained=False, ret_emb=False, pretrained_path = "_pretrained/c3d-pretrained.pth"):
        ...
        if pretrained:
            print("C3d Loading Pretrained weights")
