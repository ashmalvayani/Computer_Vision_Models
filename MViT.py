...
from .attention import MultiScaleBlock
from .helpers import stem_helper, head_helper
from .helpers.utils import round_width, validate_checkpoint_wrapper_import
...
class MViT(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if cfg.MVIT.POOL_KV_STRIDE_ADAPTIVE is not None:
            _stride_kv = list(cfg.MVIT.POOL_KV_STRIDE_ADAPTIVE)
